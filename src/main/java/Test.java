...
//        }
        ...
        System.out.println("Опубликовано: " + video.getCreatedAt().getDayOfMonth() +
                 " " + video.getCreatedAt().getMonth().getDisplayName(TextStyle.FULL, new Locale("ru")));
        System.out.println("Канал: " + video.getChannel().getName());
        System.out.println("Просмотры: " + video.getViews());
        System.out.println("Количество уникальных просмотров: " + video.getViewList().size());
//
//        Channel channel = em.find(Channel.class, 1);
